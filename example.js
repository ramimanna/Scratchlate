(function(ext) {
    ...
    ext.get_language = function(text, callback) {
      ...
      var code_to_lang = {};
      for (lang in ext.language){
        code_to_lang[ext.language[lang]] = lang;
      };
    ...
    var descriptor = {
        ...
        menus: {
            languages: Object.keys(ext.language)
        }
    };
